...
export const PlanetAttacked = ({ height, width }: AlertIcon) => {
  return (
    <img height={height} width={width} src='./public/icons/alerts/combat/planetattacked.svg' />
  );
};
...
export const TxAccepted = ({ height, width }: AlertIcon) => {
  return (
    <img height={height} width={width} src='./public/icons/alerts/transactions/accepted.svg' />
  );
};
...
export const TxDeclined = ({ height, width }: AlertIcon) => {
  return (
    <img height={height} width={width} src='./public/icons/alerts/transactions/declined.svg' />
  );
};
